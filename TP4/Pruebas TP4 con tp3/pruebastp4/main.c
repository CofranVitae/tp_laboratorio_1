...
int main()
{
    ...
    "\n15. sublist"
    "\n16. clone"
     "\n17. Guardar los datos de los empleados en el archivo data.csv (modo texto)."
     "\n18. Guardar los datos de los empleados en el archivo data.csv (modo binario)."
    "\n19. Salir"
    "\nIngrese opcion: ");
    ...
    scanf("%d", &opcion);
        ...
        case 10:
            ...
            break;
        case 11:
            ret = agregarEnIndice(listaEmpleados, &idAutoincremental);
            if(ret == 0)
            {
                printf("\nSe Agrego exitosamente");
            }
        ...
        case 12:
            ...
            break;
        case 14:
            containsall(listaEmpleados);
            break;
        case 15:
            subList(listaEmpleados);
            break;
        case 16:
            clone(listaEmpleados);
            break;
        case 17:
