...
/** \brief Permite probar la funcion ll_push
 *
 * \param lista LinkedList*
 * \param id int*
 * \return int
 *
 */
int agregarEnIndice(LinkedList* lista, int* id);
/** \brief Permite probar la funcion ll_pop
 *
 * \param pArrayListEmployee LinkedList*
 * \return int
 *
...
/** \brief Permite probar la funcion ll_sublist
 *
 * \param lista LinkedList*
 * \return int
 *
...
/** \brief Permite probar la funion ll_clone
 *
 * \param lista LinkedList*
 * \return int
 *
...
/** \brief Permite probar la funcion ll_contains y ll_containsall
 *
 * \param lista LinkedList*
 * \return int
 *
